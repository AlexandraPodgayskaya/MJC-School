...
INSERT INTO gift_certificate (id, name, description, price, duration, create_date, last_update_date) VALUES (2, 'Diving with dolphins', 'Diving with dolphins - an incredible meeting with the underwater world and its inhabitants', 1500, 1, '2020-03-20 16:34:49', '2020-05-20 16:34:49');
INSERT INTO gift_certificate (id, name, description, price, duration, create_date, last_update_date) VALUES (3, 'Horse ride', 'Horseback ride for lovers - a Hollywood-style date', 500, 2, '2017-05-22 12:46:31', '2020-03-20 16:34:49');
